...
/** @var Router $router */
$router->get('/', HomepageController::class)->name('homepage');

$router->view('/about', 'about')->name('about');
$router->view('/privacy', 'privacy')->name('privacy');

$router->get('/blog', ViewBlogIndexController::class)->name('blog.index');

$router->get('/blog/page/{page}', ViewBlogIndexController::class)->name('blog.index.paginated')
    ->whereNumber('page');
