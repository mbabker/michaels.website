...
<template>
    <header class="right relative grid grid-cols-12 items-center gap-4 py-16">
        ...
        <div
            :class="[
                'absolute bg-gray-100/70 backdrop-blur-xl dark:bg-gray-900/70',
        ...
        <!-- Desktop nav -->
        <div class="col-span-12 hidden justify-start text-xl font-medium sm:order-1 sm:col-span-8 sm:flex">
            <MainNav />
        </div>
    </header>
</template>
